	...
	<div class="panel panel-inverse">
		...
		<div class="panel-body">
            <div class="row mb-3">
                ...
                <div class="col">
                    <button class="btn btn-sm btn-success btn-filter active" data-filter="year">Year</button>
                    <button class="btn btn-sm btn-success btn-filter" data-filter="monthly">Monthly</button>
...
@push('scripts')
    ...
    <script>
        ...
        function getColumns(){
            let arr = [];
            let getCols = ['DT_RowIndex', 'date', 'poe', 'ar', 'pr', 'qr'];
        ...
        var daTable = $('#daTable').DataTable({
            ajax: {
                url: "{{ route('view.achievement.poe.list') }}",
                type: "POST",
                data: function(data){
            ...
            columnDefs: [
                ...
                {"className": "text-bold", "targets": [2, 3, 4, 5]},
            ],
