...
@section('title', 'Manage Line Process')
    ...
    <div class="d-flex align-items-center mb-3">
        <div>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Line Process</li>
            </ol>
            <h1 class="page-header mb-0">Line Process</h1>
        </div>
        <div class="ms-auto">
            <a type="button" class="btn btn-success btn-rounded px-4" onclick="create()"><i class="fa fa-plus fa-lg me-2 ms-n2 text-success-900"></i> Add Line Process</a>
        </div>
    </div>
	<!-- BEGIN panel -->
...
@push('scripts')
    ...
    <script>
        ...
        function create(){
            ...
            $('.modal-header h4').html('Create Line Process');
            $('.modal-footer .btn-success').text('Save');
            action = "{{ route('manage.line.store') }}";
            method = "POST";
        }
        function edit(id){
        ...
        function destroy(id){
            let deleteUrl = "{{ route('manage.line.destroy', ':id') }}";
