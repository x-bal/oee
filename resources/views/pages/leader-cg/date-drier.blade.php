...
@push('scripts')
    ...
    <script>
        ...
        let daTable = "{{ route('admin-cg.drier.date.list',':month') }}";
        ...
        function getData(shift, date){
            ...
            $('#oeeModal').on('shown.bs.modal', function(e){
                $.ajax({
                    url: "{{ route('admin-cg.drier.oee.list') }}",
                    type: "POST",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        shift: shift,
            ...
            Handsontable.dom.addEvent(save, 'click', () => {
                ...
                $.ajax({
                    url: "{{ route('leader-cg.drier.oee.store') }}",
                    type: "POST",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "datas": hot.getData()
            ...
            function okpDetail(row, okp){
                $.ajax({
                    url: "{{ route('leader-cg.drier.oee.okp') }}",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        okp:okp
                    },
            ...
            function removeRow(id){
                let url = "{{ route('admin-cg.drier.oee.destroy', ':id') }}";
