...
@section('content')
    <div class="d-flex align-items-center mb-3">
        <div>
            ...
            <h1 class="page-header mb-0">OEE Month {{ $line[0]['txtlinename'] }}</h1>
        </div>
    </div>
	<!-- BEGIN panel -->
	<div class="panel panel-inverse">
		...
		<div class="panel-heading">
			<h4 class="panel-title">MONTH OEE {{ $line[0]['txtlinename'] }}</h4>
                ...
                <div class="col-md-4">
                    <form action="" method="get">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <select name="line_id" id="Line" class="form-select">
                                    @foreach ($line as $key => $val)
                                        <option value="{{ $line[$key]['id'] }}">{{ $line[$key]['txtlinename'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-4">
