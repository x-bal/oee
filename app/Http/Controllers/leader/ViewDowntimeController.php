...
class ViewDowntimeController extends Controller
{
    public function getIndex()
    {
        ...
        return view('pages.leader.viewdowntime', [
            'years' => $kpi,
            'categories' => $arrCat
        ]);
    }
    ...
    public function postListDowntime(Request $request)
    {
        ...
        switch ($request->filter) {
            case 'monthly':
                $downtimes = $this->daTableMonth($year, $category);
                break;
            case 'weekly':
                $downtimes = $this->daTableWeek($year, $category);
                break;
            case 'daily':
                $downtimes = $this->daTableDaily($year, $category);
                break;
            case 'shift':
                $downtimes = $this->daTableShift($year, $category);
                break;
        }
    ...
    public function daTableMonth($year, $category)
    {
    ...
    public function daTableWeek($year, $category)
    {
    ...
    public function daTableDaily($year, $category)
    {
    ...
    public function daTableShift($year, $category)
    {
