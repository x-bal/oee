...
class OeeController extends Controller
{
    ...
    public function getMonth(Request $request)
    {
        ...
        // die();
        return view('pages.leader-cg.month', [
            'line' => $line,
            'year' => $year,
            'oee' => $loop,
        ]);
    ...
    {
        // print(substr($month, 0, 4)).'<br>';
        // print(substr($month, 4, 2)).'<br>';
        // print(substr($month, 6));
        // die();
        ...
        $code = Activity::where('line_id', substr($month, 4, 2))->pluck(
            'txtactivitycode'
        );
        $loop = [];

        return view('pages.leader-cg.date', [
            'dates' => $loop,
            'code' => $code,
