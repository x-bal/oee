...
class OperatorController extends Controller
{
    ...
    public function getMonth(Request $request)
    {
        ...
        // die();
        return view('pages.operator.month', [
            'line' => $line,
            'year' => $year,
            'oee' => $loop,
        ]);
    ...
    public function storeOee(Request $request)
    {
        ...
        foreach ($request->datas as $key => $value) {
            $result[] = [
                ...
                'production_code' => $request->datas[$key][15],
                'expired_date' => $request->datas[$key][16],
                'finish_good' => $request->datas[$key][17],
                'tech_name' => $request->datas[$key][18],
            ];
        }
